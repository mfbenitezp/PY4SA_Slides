...
::: r-stack
![](img/operators.png){.fragment .fade-in-then-out fig-align="left" width="50%"}

![](img/comparison_operators.png){.fragment .fade-in-then-out fig-align="left" width="60%"}

![](img/LogicalOperators.png){.fragment .fade-in-then-out fig-align="right" width="70%"}
:::
